      ...
      <section className="profile-card">
        {loading ? (
          ...
          <>
              ...
              <div className="settings-section">
                ...
                <div className="settings-row">
                  <div>
                    ...
                    <span>
                      ...
                      {typeof Notification !== 'undefined' && ` Permission: ${Notification.permission}`}
                    </span>
                  </div>
                  <label className={`toggle ${notificationInApp ? 'is-on' : ''}`}>
                    <input
                      type="checkbox"
                ...
                <div className="settings-row">
                  <div>
                    ...
                    <span>Get email notifications for upcoming deadlines (requires server setup).</span>
                  </div>
                  <label className={`toggle ${notificationEmail ? 'is-on' : ''}`}>
                    <input
                      type="checkbox"
                ...
                <div className="settings-row">
                  ...
                  <label className={`toggle ${theme === 'light' ? 'is-on' : ''}`}>
                    <input
                      type="checkbox"
                      checked={theme === 'light'}
                      onChange={(e) => handleToggleTheme(e.target.checked ? 'light' : 'dark')}
                    />
                  </label>
                </div>
              </div>

              <button type="submit" className="primary-btn primary-btn--light" disabled={saving}>
            ...
            {passwordResetMessage && (
              <p className={`banner ${passwordResetMessage.startsWith('Password reset email sent') ? 'banner-success' : 'banner-error'}`}>
                {passwordResetMessage}
              </p>
            )}
